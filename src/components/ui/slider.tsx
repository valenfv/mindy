...
/**
 * Slider accesible: Radix expone un `role="slider"` con soporte completo de
 * teclado (flechas, Inicio/Fin, PageUp/PageDown) sobre un thumb de 28px.
 */
  ...
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb
        className={cn(
          'block size-7 rounded-full border-2 border-primary bg-card shadow-lifted transition-transform',
